...
function addMarsLayers() {
    ...
    var marsLayer = new WorldWind.WmsLayer({
        ...
        format: "image/png",
        size: 512,
        levelZeroTileDelta: new WorldWind.Location(36, 36),
        numLevels: 10,
        transparent: false,
        version: "1.3.0",
        timeString: null,
...
// Initialize with Earth layers by default
addEarthLayers();
